...
public:
    ...
    void setupUi(QFrame *BudgetFrame)
    {
        if (BudgetFrame->objectName().isEmpty())
            BudgetFrame->setObjectName(QStringLiteral("BudgetFrame"));
    ...
    void retranslateUi(QFrame *BudgetFrame)
    {
        ...
        saveMoneyButton_2->setText(QApplication::translate("BudgetFrame", "Save Money", 0));
        ...
        saveMoneyButton->setText(QApplication::translate("BudgetFrame", "Save Money", 0));
    } // retranslateUi
