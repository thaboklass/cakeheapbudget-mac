#ifndef UI_EDITED_INCOME_DIALOG_H_INCLUDED
#define UI_EDITED_INCOME_DIALOG_H_INCLUDED
...
public:
    ...
    void setupUi(QDialog *incomeDialog)
    {
        ...
        okButton->setGeometry(QRect(330, 240, 75, 32));
        cancelButton = new QPushButton(incomeBox);
        cancelButton->setObjectName(QString::fromUtf8("cancelButton"));
        cancelButton->setGeometry(QRect(258, 240, 75, 32));
    ...
    void retranslateUi(QDialog *incomeDialog)
    {
        ...
        incomeBox->setTitle(QApplication::translate("incomeDialog", "", 0));
...
namespace Ui {
    class editedIncomeDialog: public Ui_editedIncomeDialog {};
} // namespace Ui
...
#endif // UI_EDITED_INCOME_DIALOG_H_INCLUDED
